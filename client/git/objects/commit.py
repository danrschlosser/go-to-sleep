...
class Commit(base.Object, Iterable, Diffable, Traversable, Serializable):
    ...
    def __init__(self, repo, binsha, tree=None, author=None, authored_date=None,
    ...
    def _deserialize(self, stream):
        ...
        try:
            ...
            print >> sys.stderr, "Failed to decode message '%s' using encoding %s" % (
            self.message, self.encoding)
