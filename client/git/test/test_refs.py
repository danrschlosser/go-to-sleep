...
class TestRefs(TestBase):
    ...
    def test_head_reset(self, rw_repo):
        ...
        self.failUnlessRaises(ValueError, cur_head.reset, new_head_commit, index=False,
                              working_tree=True)
        ...
        self.failUnlessRaises(GitCommandError, cur_head.reset, new_head_commit, working_tree=True,
                              paths="lib")
        ...
        for count, new_name in enumerate(("my_new_head", "feature/feature1")):
            ...
            self.failUnlessRaises(OSError, Head.create, rw_repo, new_name,
        ...
        self.failUnlessRaises(OSError, SymbolicReference.create, rw_repo, symref_path,
