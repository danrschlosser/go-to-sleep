...
class RemoteProgress(object):
    ...
    """
    _num_op_codes = 7
    BEGIN, END, COUNTING, COMPRESSING, WRITING, RECEIVING, RESOLVING = [1 << x for x in
                                                                        range(_num_op_codes)]
    ...
    def _parse_progress_line(self, line):
        ...
        for sline in sub_lines:
            ...
            if op_name == "Counting objects":
                ...
                self.line_dropped(sline)
                sys.stderr.write(
                    "Operation name %r unknown - skipping line '%s'" % (op_name, sline))
        ...
        while True:
            try:
                ...
                if curtime >= maxtime:
                    ...
                    maxtime - starttime, self._lock_file_path())
                    raise IOError(msg)
